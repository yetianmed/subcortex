...
**I just want the atlas! Where can I find it?** Go to the directory called *Group-Parcellation/3T/Subcortex-Only/*. There you will find the group-consensus atlas in NIFTI and CIFTI format for download. Continue reading below for further details and FAQs. 
