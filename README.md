...
**What atlas scale should I choose?** This really depends on the purpose for which the atlas is used. If you intend to incorporate the atlas into an existing cortex-only atlas, choose a scale that is commensurate with the cortex-only atlas. 
