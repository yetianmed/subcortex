function [img_mag_null,img_pca_null]=gradmNull(savg,roiFile,NumNull)
...
[~,img_pca_null]=connectopic_laplacian(savg,ind_ins,N,Vn,Null,NumNull);
...
for j=1:NumNull
    ...
    Streamlines=0;
    Mag=1;
    [Gx,Gy,Gz]=compute_gradients(img_pca_null_dilate,ins_msk,Mag,Streamlines,Subject);
